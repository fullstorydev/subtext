...
- `snippet_not_found` or `api_unavailable`: tell the user the Subtext capture snippet isn't installed (or the capture API is unreachable) and they should re-run the install steps.
