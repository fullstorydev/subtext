...
> **PREREQUISITE — Read inline before any other action:** Read skills `subtext:session`, `subtext:live`, `subtext:sightmap`, `subtext:shared`, `subtext:tunnel`. Do not use the Skill tool — read the files directly.
