...
> **PREREQUISITE — Read inline before any other action:** Read skill `subtext:sightmap` for the full schema reference. Do not use the Skill tool — read the file directly.
