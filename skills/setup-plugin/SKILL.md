...
- **Skills** — `proof` (before/after evidence for UI changes), `review` (structured summary of any session), plus the underlying tool catalogs (`live`, `session`, `comments`, `tunnel`, `sightmap`)
