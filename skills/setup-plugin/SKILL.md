...
- `live-tunnel` — optional (local tunnel client)
...
1. **MCP connectivity test failed** — the session-review or devtools-hosted server did not respond.
...
- **MCP servers** — session replay, devtools, and tunnel tools
